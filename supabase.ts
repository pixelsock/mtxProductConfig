  ...
  public: {
    Tables: {
      ...
      rules_disabled: {
        ...
        Relationships: [
          {
            foreignKeyName: "rules_disabled_rules_id_foreign"
            columns: ["rules_id"]
            isOneToOne: false
      ...
      rules_if_selected: {
        ...
        Relationships: [
          {
            foreignKeyName: "rules_if_selected_rules_id_foreign"
            columns: ["rules_id"]
            isOneToOne: false
            referencedRelation: "rules"
            referencedColumns: ["id"]
      ...
      rules_required: {
        ...
        Relationships: [
          {
            foreignKeyName: "rules_required_rules_id_foreign"
            columns: ["rules_id"]
            isOneToOne: false
            referencedRelation: "rules"
            referencedColumns: ["id"]
