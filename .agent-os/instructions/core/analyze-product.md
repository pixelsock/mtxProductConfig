...
<instructions>
  ...
  REFERENCE: Use `docs/api-checks.md` to validate live Directus data shapes (collections, fields, sample payloads) before updating docs
  UPDATE: If you discover schema or rules changes during analysis, update `docs/api-checks.md` with new/modified checks
</instructions>
...
<instructions>
  ...
  REFERENCE: Confirm assumptions with terminal checks from `docs/api-checks.md` before finalizing docs
</instructions>
...
<verification_checklist>
  ...
  - [ ] `docs/api-checks.md` updated or confirmed current for the changed schema/rules
</verification_checklist>
