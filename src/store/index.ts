...
export const useCurrentProduct = () =>
  useConfiguratorStore((state) => state.currentProduct);
export const useCurrentProductLine = () =>
  useConfiguratorStore((state) => state.currentProductLine);
...
export const useSkuSearchState = () => {
  const skuSearchQuery = useConfiguratorStore((state) => state.skuSearchQuery);
  const skuSearchResults = useConfiguratorStore(
    (state) => state.skuSearchResults,
  );
  const isSearchingSku = useConfiguratorStore((state) => state.isSearchingSku);
  const skuSearchError = useConfiguratorStore((state) => state.skuSearchError);
  ...
  return useMemo(
    ...
    [skuSearchQuery, skuSearchResults, isSearchingSku, skuSearchError],
  );
};

export const useShowQuoteForm = () =>
  useConfiguratorStore((state) => state.showQuoteForm);
export const useShowFloatingBar = () =>
  useConfiguratorStore((state) => state.showFloatingBar);
export const useIsLightboxOpen = () =>
  useConfiguratorStore((state) => state.isLightboxOpen);
export const useLightboxIndex = () =>
  useConfiguratorStore((state) => state.lightboxIndex);
export const useUseCustomSize = () =>
  useConfiguratorStore((state) => state.useCustomSize);
export const useCanScrollLeft = () =>
  useConfiguratorStore((state) => state.canScrollLeft);
export const useCanScrollRight = () =>
  useConfiguratorStore((state) => state.canScrollRight);
...
export const useAvailableProductLines = () =>
  useConfiguratorStore((state) => state.availableProductLines);
export const useConfigurationUI = () =>
  useConfiguratorStore((state) => state.configurationUI);
export const useDisabledOptionIds = () =>
  useConfiguratorStore((state) => state.disabledOptionIds);
export const useIsLoadingApp = () =>
  useConfiguratorStore((state) => state.isLoadingApp);
export const useIsLoadingProductLine = () =>
  useConfiguratorStore((state) => state.isLoadingProductLine);
export const useIsComputingAvailability = () =>
  useConfiguratorStore((state) => state.isComputingAvailability);
export const useError = () => useConfiguratorStore((state) => state.error);

export const useRuleImageOverrides = () =>
  useConfiguratorStore((state) => state.ruleImageOverrides);
...
export const useQuoteItems = () =>
  useConfiguratorStore((state) => state.quoteItems);
export const useCustomerInfo = () =>
  useConfiguratorStore((state) => state.customerInfo);
...
export const useConfigurationActions = () => {
  const updateConfiguration = useConfiguratorStore(
    (state) => state.updateConfiguration,
  );
  const setCurrentProduct = useConfiguratorStore(
    (state) => state.setCurrentProduct,
  );
  const setCurrentProductLine = useConfiguratorStore(
    (state) => state.setCurrentProductLine,
  );
  const resetConfiguration = useConfiguratorStore(
    (state) => state.resetConfiguration,
  );
  const incrementQuantity = useConfiguratorStore(
    (state) => state.incrementQuantity,
  );
  const decrementQuantity = useConfiguratorStore(
    (state) => state.decrementQuantity,
  );
  const handleSizePresetSelect = useConfiguratorStore(
    (state) => state.handleSizePresetSelect,
  );
...
export const useSkuSearchActions = () => {
  ...
  const clearSkuSearch = useConfiguratorStore((state) => state.clearSkuSearch);
  ...
  return useMemo(
    ...
    [searchBySku, applySkuResult, clearSkuSearch],
  );
};

export const useUIActions = () => {
  const toggleQuoteForm = useConfiguratorStore(
    (state) => state.toggleQuoteForm,
  );
  const setQuoteFormVisible = useConfiguratorStore(
    (state) => state.setQuoteFormVisible,
  );
  const setFloatingBarVisible = useConfiguratorStore(
    (state) => state.setFloatingBarVisible,
  );
  ...
  const toggleCustomSize = useConfiguratorStore(
    (state) => state.toggleCustomSize,
  );
  const setCustomSizeEnabled = useConfiguratorStore(
    (state) => state.setCustomSizeEnabled,
  );
...
export const useAPIActions = () => {
  const setProductOptions = useConfiguratorStore(
    (state) => state.setProductOptions,
  );
  const setAvailableProductLines = useConfiguratorStore(
    (state) => state.setAvailableProductLines,
  );
  const setConfigurationUI = useConfiguratorStore(
    (state) => state.setConfigurationUI,
  );
  const setDisabledOptions = useConfiguratorStore(
    (state) => state.setDisabledOptions,
  );
  const setLoadingApp = useConfiguratorStore((state) => state.setLoadingApp);
  const setLoadingProductLine = useConfiguratorStore(
    (state) => state.setLoadingProductLine,
  );
  const setComputingAvailability = useConfiguratorStore(
    (state) => state.setComputingAvailability,
  );
  const setError = useConfiguratorStore((state) => state.setError);
  const clearError = useConfiguratorStore((state) => state.clearError);
  const loadProductLineOptions = useConfiguratorStore(
    (state) => state.loadProductLineOptions,
  );
  const recomputeFiltering = useConfiguratorStore(
    (state) => state.recomputeFiltering,
  );
...
export const useQuoteActions = () => {
  ...
  const setCustomerInfo = useConfiguratorStore(
    (state) => state.setCustomerInfo,
  );
  const resetCustomerInfo = useConfiguratorStore(
    (state) => state.resetCustomerInfo,
  );
...
export const useIsConfigurationValid = () =>
  useConfiguratorStore((state) => state.isConfigurationValid);
export const useGetGeneratedSKU = () =>
  useConfiguratorStore((state) => state.getGeneratedSKU);
export const useGenerateProductName = () =>
  useConfiguratorStore((state) => state.generateProductName);
export const useGetTotalItems = () =>
  useConfiguratorStore((state) => state.getTotalItems);
export const useGetQuoteDescription = () =>
  useConfiguratorStore((state) => state.getQuoteDescription);
